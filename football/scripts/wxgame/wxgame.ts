    ...
    async onFile(file: plugins.File) {
        if (file.extname == '.js') {
            ...
            if (filename == 'libs/modules/egret/egret.js' || filename == 'libs/modules/egret/egret.min.js') {
                ...
                if (filename == "libs/modules/agfUtil/agfUtil.js" || filename == 'libs/modules/agfUtil/agfUtil.min.js') {
                   content = content.replace(/agf/, "window.agf=agf");
                }
                if (filename == "libs/physics/physics.js") {
                    content = content.replace(/ module\.exports = a/, "window.p2 = a");
                }
                if (filename == 'libs/physics/physics.min.js') {
                    content = content.replace(/module\.exports=t/, "window.p2=t");
                }
